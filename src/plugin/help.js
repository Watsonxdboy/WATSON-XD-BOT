...
╰─────────────━┈⊷ `
            ...
            footer: proto.Message.InteractiveMessage.Footer.create({
              text: "© ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚆𝙰𝚃𝚂𝙾𝙽-xᴅ-ʙᴏᴛ"
            }),
            header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./src/watson.jpg')}, { upload: Matrix.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: "",
          ...
          "buttonParamsJson": JSON.stringify({
            ...
            id: `${prefix}ping`
        ...
        },
                {
                 ...
                 "sections":
                   [{
                    "title":"🤩 𝗪𝗔𝗧𝗦𝗢𝗡-𝗫𝗗 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "highlight_label":"🤩 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "rows":[
                      {
                       "header":"",
                       "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"🚀 𝗪𝗔𝗧𝗦𝗢𝗡-X𝐷 𝛥𝐿𝐿𝛭𝛯𝛮𝑈🎨",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
...
╰━━━━━━━━━━━━━━━⪼
  ...
  image: fs.readFileSync('./src/watson.jpg'), 
  caption: str, 
  contextInfo: { 
                  mentionedJid: [m.sender], 
                  forwardingScore: 999,
