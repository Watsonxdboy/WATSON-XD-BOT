      ...
      if (selectedMedia) {
        try {
          ...
          if (type === 'video' && fileSizeInMB <= 300) {
            content = { video: finalMediaBuffer, mimetype: 'video/mp4', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚆𝙰𝚃𝚂𝙾𝙽-xᴅ-ʙᴏᴛ' };
          } else if (type === 'audio' && fileSizeInMB <= 300) {
            content = { audio: finalMediaBuffer, mimetype: 'audio/mpeg', caption: '> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝚆𝙰𝚃𝚂𝙾𝙽-xᴅ-ʙᴏᴛ' };
          }
